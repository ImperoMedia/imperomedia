		...
		<div class="row"><!--ROW ONE-->
			...
			<div class="col-xs-12 col-sm-6 col-med-4 col-lg-4">
				<div class="view view-tenth">
					...
					<a href="<?php the_field('port_link_1-1'); ?>" class="info">View Case Study</a>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-med-4 col-lg-4">
				<div class="view view-tenth">
					...
					<div class="mask">
						...
						<a href="<?php the_field('port_link_3-1'); ?>" class="info">View Case Study</a>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-med-4 col-lg-4">
				<div class="view view-tenth">
					...
					<div class="mask">
						...
						<a href="<?php the_field('port_link_1-2'); ?>" class="info">View Case Study</a>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-med-4 col-lg-4">
				<div class="view view-tenth">
					...
					<div class="mask">
						...
						<a href="<?php the_field('port_link_2-2'); ?>" class="info">View Case Study</a>
					</div>
				</div>
			</div>
			<!-- /.col-lg-4 -->
			...
			<div class="col-xs-12 col-sm-6 col-med-4 col-lg-4">
				<div class="view view-tenth">
					...
					<div class="mask">
						...
						<a href="<?php the_field('port_link_3-2'); ?>" class="info">View Case Study</a>
					</div>
				</div>
			</div>
			<!-- /.col-lg-4 -->  
