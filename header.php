...
<header id="masthead" class="site-header" role="banner">
		...
		<div class="nav-container">
			...
			<div class="nav-social">
				<ul>
					<li><a title="Twitter" href="http://twitter.com/imperomedia"><i class="fa fa-twitter fa-2x"></i></a></li>
					<li><a title="Facebook" href="http://facebook.com/imperomedia"><i class="fa fa-facebook fa-2x"></i></a></li>
					<li><a title="Instagram" href="http://instagram.com/imperomedia"><i class="fa fa-instagram fa-2x"></i></a></li>
					<li><a title="GitHub" href="https://github.com/ImperoMedia"><i class="fa fa-github fa-2x"></i></a></li>
					<li><a title="Reddit" href="http://www.reddit.com/user/imperomedia/"><i class="fa fa-reddit fa-2x"></i></a></li>
				</ul>
			</div>
